/*
   ==UserScript==
 @name         TP02Q09 - Heapsort em Java
 @namespace    https://github.com/Ddavidi/PUC-MINAS
 @description  VERDE PUC MINAS - TP02Q09 - Heapsort em Java
 @author       @ddavidi_
   ==/UserScript==
*/
...
public class Principal {
    public static void main(String[] args) {
        ...
        Show.heapsortPorDiretor(arrayShows, i);
        for (int j = 0; j < i; j++) {
...
class Show {
    ...
    public static void heapsortPorDiretor(Show[] array, int n) {
