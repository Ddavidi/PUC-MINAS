/*
   ==UserScript==
 @name         TP04Q07 - Tabela Hash Indireta com Lista Simples
 @namespace    https://github.com/Ddavidi/PUC-MINAS
 @description  VERDE PUC MINAS - TP04Q07 - Tabela Hash Indireta com Lista Simples
 @author       @ddavidi_
   ==/UserScript==
*/
...
public class TabelaHashListaSimples {
...
class Lista {
    ...
    public boolean pesquisarLista(String titulo) {
        boolean resp = false;
        Celula atual = this.primeiro.prox;
        while (atual != null) {
            if (atual.elemento.getTitle().equals(titulo)) {
                resp = true;
                atual = null;
            }else{
                atual = atual.prox;
...
class Hash{
    ...
    public static int rehash(String titulo) {
        return (toInteger(titulo) + 1) % TAM;
    }
    ...
    public boolean pesquisar(String titulo) {
        ...
        boolean resp = lista[posicao].pesquisarLista(titulo);
        return resp;
    }
