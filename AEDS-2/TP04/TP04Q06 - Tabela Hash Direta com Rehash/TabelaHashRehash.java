/*
   ==UserScript==
 @name         TP04Q06 - Tabela Hash Direta com Rehash
 @namespace    https://github.com/Ddavidi/PUC-MINAS
 @description  VERDE PUC MINAS - TP04Q06 - Tabela Hash Direta com Rehash
 @author       @ddavidi_
   ==/UserScript==
*/
...
class Hash{
    ...
    public boolean pesquisar(String titulo) {
        ...
        if (array[posicao] == null) {
            ...
            posicao = rehash(titulo);
            if (array[posicao] == null) {
                resp = false;
            } else {
                resp = array[posicao].getTitle().equals(titulo);
            }
        }
        return resp;
    }
