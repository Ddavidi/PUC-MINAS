...
for i in range(240, 260):
    ...
    text = page.get_text()
    if "prático 7.3\n" in text.lower() or "prático 7.3 " in text.lower() or "prático 7.3" in text.lower():
...
if found_page != -1:
    ...
    img_path = r"c:\Users\DD\Documents\DD\PUC MINAS\PUC-MINAS\CIRCUITOS ELETRICOS\_base_dados_ia\imagens_geradas\sadiku_page_7_3.png"
    pix.save(img_path)
