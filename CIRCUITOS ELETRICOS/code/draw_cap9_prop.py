...
# Triângulo para o Cap 9 Exercicio Proposto
draw_triangle(73.01, -111.03, 132.88, -56.67, "cap9_exercicio_proposto_triangulo.png", "Triângulo de Potências (Cap 9 - Proposto)")

print("Triângulo gerado com sucesso.")
